...
from fairseq.data import FileAudioDataset, Dictionary, AddTargetDataset,MTL_Dictionary
...
@register_task("audio_mtl")
class Audio_MTL_PredictionTask(FairseqTask):
    """
        ...
        if not self.args.datasets:
            ...
            for dataset in datasets:
                ...
                if self.args.labels:
                    ...
                    dataset_map[dataset] = AddTargetDataset(
                        dataset_map[dataset],
                        labels,
                        pad=self.target_dictionary.pad(),
                        eos=self.target_dictionary.eos(),
