...
class Wav2VecEncoder(FairseqEncoder):
    def __init__(self, args, tgt_dict=None):
        ...
        if not args.w2v_path2 is None:
            d = w2v_args_base.encoder_embed_dim
        ...
        if tgt_dict is not None:
            ...
            self.proj_asr = Linear(d, len(tgt_dict))
        else:
            self.proj = None
            self.proj_asr = None
...
@register_model_architecture("wav2vec_class", "wav2vec_class")
