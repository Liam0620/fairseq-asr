...
class Trainer(object):
    ...
    def get_valid_iterator(
        ...
        return self.task.get_batch_iterator(
            ...
            required_batch_size_multiple=self.args.required_batch_size_multiple,
            seed=self.args.seed,
            num_shards=self.data_parallel_world_size, #self.data_parallel_world_size,
            shard_id=self.data_parallel_rank,  #self.data_parallel_rank
            num_workers=self.args.num_workers
        )
    ...
    def valid_step(self, sample, raise_oom=True):
